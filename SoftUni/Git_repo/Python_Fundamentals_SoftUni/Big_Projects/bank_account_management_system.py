...
def create_account():
    ...
    account_holders_name = input('Please enter your name: ')
    # 2. Add the new account holder to the list of account holders.
    account_holders.append(account_holders_name)
...
def deposit():
    ...
    # 1. Prompt the user for the account holder's name.
    users_name = input('Please enter name of the accounts holder\'')
    # 2. Check if the account exists in the system.
    if users_name in account_holders:
        # 3. If the account exists, prompt the user for the amount to deposit.
        deposit_amount = int(input("Enter the amount of the deposit:"))
        # 4. Update the account's balance with the deposited amount.
        balances.index(account_holders)
